...
turtlebotGoDistance(0.91, velocityPublisher, odometrySubscriber)
turtlebotTurnAngle(79, velocityPublisher, odometrySubscriber);
turtlebotGoDistance(0.93, velocityPublisher, odometrySubscriber)
turtlebotTurnAngle(79, velocityPublisher, odometrySubscriber);
turtlebotGoDistance(0.93, velocityPublisher, odometrySubscriber)
turtlebotTurnAngle(79, velocityPublisher, odometrySubscriber);
turtlebotGoDistance(0.42, velocityPublisher, odometrySubscriber);
%---------------------------------
